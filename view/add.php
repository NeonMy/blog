                ...
                <div class="col-md-6">
                    ...
                    <form role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <input name="name" type="input" class="form-control" id="exampleInputEmail1" placeholder="Enter name">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Secon Name</label>
                            <input name="secontName" type="input" class="form-control" id="exampleInputEmail1" placeholder="Enter Secont name">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="role" type="input" class="form-control" id="exampleInputEmail1" placeholder="Enter Role">
                        </div>
