                ...
                <div class="col-md-6">
                    ...
                    <form role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <input name="name" value="<?=$user['name']?>" type="input" class="form-control" id="exampleInputEmail1" placeholder="Enter name">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Second Name</label>
                            <input name="secontName" value="<?=$user['second_name']?>" type="input" class="form-control" id="exampleInputEmail1" placeholder="Enter Secont name">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Email address</label>
                            <input name="email" value="<?=$user['email']?>" type="email" class="form-control" id="exampleInputEmail1" placeholder="Enter email">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="role" value="<?=$user['role']?>" type="input" class="form-control" id="exampleInputEmail1" placeholder="Enter Role">
                        </div>
